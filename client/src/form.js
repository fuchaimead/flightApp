...
class FlightForm extends React.Component {
  ...
  renderContent() {
    const { actual_instrument_hours, airplane_mel, airplane_sel, arrival, cross_country_hours, day_hours, departure, dual_received, identification, 
      ...
      <div>
        ...
        <Grid columns={2}>
          <Grid.Column>
            ...
            <Divider />
            <Form.Group widths="equal">
              <Form.Input fluid label="Dual Received" placeholder="Dual Received" id="dual_received" value={dual_received} onChange={this.handleChange} type="number" min="0" step="0.1"/>
              <Form.Input fluid label="Pilot-in-Command" placeholder="Pilot-in-Command" id="pic_hours" value={pic_hours} onChange={this.handleChange} type="number" min="0" step="0.1"/>
            </Form.Group>
          </Grid.Column>
        ...
        <Grid>
          ...
          <Divider />
          <Form.Group>
            <Form.Input label="Day" placeholder="Day" width={4} id="day_hours" value={day_hours} onChange={this.handleChange} type="number" min="0" step="0.1"/>
            <Form.Input label="Night" placeholder="Night" width={4} id="night_hours" value={night_hours} onChange={this.handleChange} type="number" min="0" step="0.1"/>
            <Form.Input label="Cross Country" placeholder="Cross Country" width={4} id="cross_country_hours" value={cross_country_hours} onChange={this.handleChange} type="number" min="0" step="0.1"/>
          </Form.Group>
          <Form.Group>
            <Form.Input label="Actual Instrument" placeholder="Actual Instrument" width={4} id="actual_instrument_hours" value={actual_instrument_hours} onChange={this.handleChange} type="number" min="0" step="0.1"/>
        ...
        <Grid>
          <Grid.Column>
            ...
            <Form.Group>
              ...
              <Form.Input label="No. Landings Day" placeholder="No. Landings Day" width={4} id="num_landings_day" value={num_landings_day} onChange={this.handleChange} type="number" min="0" step="1"/>
              <Form.Input label="No. Landings Night" placeholder="No. Landings Night" width={4} id="num_landings_night" value={num_landings_night} onChange={this.handleChange} type="number" min="0" step="1"/>
            </Form.Group>
            <Form.Group>
              ...
              <Form.Input label="Solo Flight" placeholder="Solo Flight" width={4} id="solo_hours" value={solo_hours} onChange={this.handleChange} type="number" min="0" step="0.1"/>
              <Form.Input label="Total Duration" placeholder="Total Duration" width={4} id="total_duration" value={total_duration} onChange={this.handleChange} type="number" min="0" step="0.1"/>
            </Form.Group>
          </Grid.Column>
        </Grid>
